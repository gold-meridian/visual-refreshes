...
internal static class PrimitiveRenderer
{
    ...
    public static void DrawStrip(Vector2[] positions, float[] rotations, StripColorFunction color, StripWidthFunction width, Vector2 offset = default)
    {
        ...
        var vertices = new VertexRenderData[length * 2];
    ...
    private static void SetVertexPair(ref VertexRenderData[] vertices, Vector2 position, float rotation, StripColorFunction colorFunction, StripWidthFunction widthFunction, int i)
    {
    ...
    private static void SetIndices(ref short[] indices, in VertexRenderData[] vertices)
    {
        short iI = 0;
